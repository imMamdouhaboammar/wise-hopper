...
export function MainHeader() {
  ...
  return (
    <header className="border-b border-lavender-border/70 sticky top-0 bg-background/95 backdrop-blur-md z-40 transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 h-20 flex items-center justify-between">
        {/* Brand Logo & Desktop Nav */}
        <div className="flex items-center gap-8 lg:gap-10">
          <Link
            href="/"
            className="flex items-center gap-3.5 group focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-primary rounded-xl p-1 -m-1"
          >
            <span className="w-10 h-10 rounded-xl bg-linear-to-br from-primary to-[#4B2F9F] text-white flex items-center justify-center font-bold text-xl shadow-soft-xs group-hover:scale-105 group-hover:shadow-soft-sm transition-all duration-200">
              و
            </span>
            <div className="flex flex-col">
              ...
              <span className="text-xs text-ink-secondary">نشر تحريري عربي مستقل</span>
            </div>
          </Link>
              ...
              return (
                <Link
                  ...
                  className={`px-3.5 py-2 rounded-xl transition-all duration-150 ${
                    active
                      ? 'text-primary font-semibold bg-lavender/70 shadow-2xs'
                      : 'text-ink-secondary hover:text-ink-primary hover:bg-lavender/40'
                  }`}
                >
                  {item.name}
                </Link>
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/studio"
            className="hidden lg:inline-flex items-center gap-1.5 px-3.5 py-2 text-xs font-semibold text-ink-secondary hover:text-primary hover:bg-lavender/50 rounded-xl transition-all border border-lavender-border/70"
          >
          ...
          <Link
            href="/newsletter"
            className="hidden sm:inline-flex items-center justify-center px-4 py-2 text-sm font-semibold text-white bg-primary hover:bg-primary-hover active:bg-primary-active rounded-xl shadow-soft-xs hover:shadow-soft-sm transition-all active:scale-[0.98]"
          >
            اشترك في النشرة
          </Link>
          ...
          <button
            ...
            className="md:hidden p-2.5 rounded-xl text-ink-secondary hover:text-ink-primary hover:bg-lavender/40 focus:outline-hidden focus:ring-2 focus:ring-primary transition-colors cursor-pointer"
