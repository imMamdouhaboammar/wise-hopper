...
export function StudioHeader() {
  ...
  return (
    <header className="bg-background/95 border-b border-lavender-border/70 sticky top-0 z-30 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 h-16 flex items-center justify-between">
        <div className="flex items-center gap-6">
          ...
          >
            <span className="w-8 h-8 rounded-lg bg-linear-to-br from-primary to-[#4B2F9F] text-white flex items-center justify-center font-bold text-sm shadow-soft-xs group-hover:scale-105 transition-transform">
              و
            </span>
            <div className="flex flex-col">
              ...
              <span className="text-xs text-ink-secondary leading-none">مساحة الكاتب المالك</span>
            </div>
          </Link>
