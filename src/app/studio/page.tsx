  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-8 rounded-3xl border border-lavender-border shadow-xs">
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary hover:bg-primary-hover active:bg-primary-active text-white text-sm font-semibold rounded-xl shadow-xs transition-all active:scale-[0.98]"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-2xl border border-lavender-border shadow-2xs hover:shadow-xs transition-shadow">
          ...
          <span className="text-[11px] text-emerald-600 font-medium inline-flex items-center gap-1 mt-2">
        ...
        <div className="bg-white p-6 rounded-2xl border border-lavender-border shadow-2xs hover:shadow-xs transition-shadow">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="w-9 h-9 rounded-xl bg-lavender text-primary flex items-center justify-center">
              <FileEdit className="w-4 h-4" />
            </div>
          </div>
          <div className="text-3xl font-extrabold text-ink-primary">{counts.drafts}</div>
          <span className="text-[11px] text-primary font-medium inline-flex items-center gap-1 mt-2">
            <span>●</span>
        ...
        <div className="bg-white p-6 rounded-2xl border border-lavender-border shadow-2xs hover:shadow-xs transition-shadow">
          ...
          <span className="text-[11px] text-purple-600 font-medium inline-flex items-center gap-1 mt-2">
            <span>●</span>
      ...
      <div className="bg-white p-6 rounded-2xl border border-lavender-border shadow-2xs">
        <h2 className="text-sm font-bold text-ink-primary mb-4">حالة سلامة منظومة النشر الحتمية</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
          <div className="p-4 bg-lavender-light rounded-xl border border-lavender-border/80">
